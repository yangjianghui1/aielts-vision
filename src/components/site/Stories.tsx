...
const ROW_A: Story[] = [
  { name: "林可颐", meta: "上海 · 曼彻斯特大学", quote: "写作一直卡 6，AI 反馈把逻辑断层和替换词一次性标出来，第一次看清 7 分作文怎么写。", gain: "6.0 → 7.5" },
  { name: "陈屿", meta: "成都 · 加拿大技术移民", quote: "口语 Part 2 全程计时加转写，填充词多到自己都吓一跳，两周就改过来了。", gain: "6.5 → 7.5" },
  { name: "赵一宁", meta: "北京 · 帝国理工硕士", quote: "听力解析直接定位到 Section 3 错题的原文句，反复精听后瓶颈终于破了。", gain: "7.0 → 8.0" },
  { name: "黄嘉树", meta: "广州 · NHS 护理注册", quote: "全职工作只能晚上练，AI 评分报告帮我锁定薄弱题型，每次 30 分钟都有明确目标。", gain: "5.5 → 7.0" },
];

const ROW_B: Story[] = [
  { name: "苏婉", meta: "杭州 · 墨尔本大学", quote: "模考界面和真实机考几乎一样，考试当天完全没有陌生感。", gain: "6.5 → 8.0" },
  { name: "何知远", meta: "武汉 · 德国工程硕士", quote: "写作范文按分数段拆解，6.5 和 7.5 的差距一目了然，替换词表直接抄进模板。", gain: "6.5 → 7.5" },
  { name: "毕宁", meta: "南京 · 英国博士", quote: "模考预估分和实际只差 0.5，考前心里有底这件事比什么都重要。", gain: "7.0 → 8.5" },
